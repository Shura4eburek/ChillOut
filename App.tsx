...
// Изображения для фонов (Локальные пути - исправлено на resources)
const BACKGROUNDS = {
  overworld: "/resources/backgrounds/overworld.png", 
  nether: "/resources/backgrounds/nether.png",     
  end: "/resources/backgrounds/end.png"         
};
